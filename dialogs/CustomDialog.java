...
// Creates and styles the window of most of the popup dialogs shown to the user
public class CustomDialog extends Stage {
    ...
    public CustomDialog(String header, String content){
        ...
        Rectangle bg = new Rectangle(root.getWidth() + 410, root.getHeight() + 150, Color.LAVENDER);
