...
// Creates and styles the window that shows the condition of the last five shots made
// when the "Player Shots" and "Enemy Shots" button is clicked from the "Details" menu
public class CustomDialogShots extends Stage{
    ...
    public CustomDialogShots(String header, String content){
        Pane root = new Pane();
        ...
        Rectangle bg = new Rectangle(root.getWidth() + 400, root.getHeight() + 480, Color.LAVENDER);
